  ...
  const experiences = [
    {
      ...
      type: "Full-time",
      achievements: [
        "Designed and developed a Cabin Booking Management System, improving workspace utilization efficiency by 30%",
        "Implemented RESTful APIs using Python FastAPI framework, reducing booking request processing time by 40%",
        "Created responsive UI components with React, enhancing user experience for 1000+ employees",
        "Collaborated with cross-functional teams to deliver projects within scheduled timelines, integrating CI/CD pipeline",
        "Maintained and optimized SQL databases for efficient data retrieval and storage",
